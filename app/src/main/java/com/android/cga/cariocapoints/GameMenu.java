        ...
        StartGame.OnFragmentInteractionListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_game_menu, container, false);

        playerBtn = (Button) myView.findViewById(R.id.playersBtn);
        playerBtn.setOnClickListener(this);

        startBtn = (Button) myView.findViewById(R.id.startBtn);
        ...
        switch (v.getId()){
            case R.id.playersBtn:
                getFragmentManager().beginTransaction()
                        .replace(((ViewGroup) getView().getParent()).getId(), new NewPlayers())
                        .commit();
                break;
            case R.id.startBtn:
                getFragmentManager().beginTransaction()
                        .replace(((ViewGroup) getView().getParent()).getId(), new StartGame())
                        .commit();
